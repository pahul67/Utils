...
public class XlatCountryName2ISO {
	...
	private static String[] data = {
		...
		"218;ba;591;null;yes;Bosnia and Herzegovina;",
		"652;bw;387;null;yes;Botswana;",
...
//		"225;see;379;null;yes;",			// ??? 'see' should be 'va'
		...
		"423;ps;970;null;yes;Palestinian Territory, Occupied;",
		...
		"450;kr;52;00798148007425;no;Korea, Republic of;",
...
//		"234;gb;44;08082381789;no;United Kingdom;",
  ...
  /**
   * returns 2-letter ISO code corresponding to full text country name used in "Hide My Ass" free proxy lists
   *
   * @param name	Country name as used by "Hide My Ass" free proxy lists
   * @return String 	2-letter ISO country code
   */
	public static String name2Iso(String name) {
		if(hm == null) {
		...
		return hm.containsKey(name) ? hm.get(name) : null;
	}
